						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="Method" type="text" placeholder="Enter Method" v-model="paymentToAdd.method"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Amount</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Amount" type="text" placeholder="Enter Amount" v-model="paymentDetails.amount"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Payment Date</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Method</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Method" type="text" placeholder="Enter Method" v-model="paymentDetails.method"></input>
																		</div>
						</td>
														</tr>

						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div id="app">
								  ...
								  <base-input label="Duration" type="text" placeholder="Enter Duration" v-model="flightToAdd.duration"></base-input>
								  <base-input label="Status" type="text" placeholder="Enter Status" v-model="flightToAdd.status"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Departure Time</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="DepartureTime" type="text" placeholder="Enter DepartureTime" v-model="flightDetails.departureTime"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Arrival Time</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ArrivalTime" type="text" placeholder="Enter ArrivalTime" v-model="flightDetails.arrivalTime"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Duration</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Duration" type="text" placeholder="Enter Duration" v-model="flightDetails.duration"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Status</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Status" type="text" placeholder="Enter Status" v-model="flightDetails.status"></input>
																		</div>
						</td>
														</tr>
